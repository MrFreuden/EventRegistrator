...
namespace TimeSlotParserTests
{
    public class TimeSlotParserTests
    {
        ...
        public void ParseRegistrationMessage_MultipleSlotsSingleLine_ReturnsMultipleRegistrations1()
        {
            ...
            Assert.That(result, Is.Not.Null);
            Assert.That(result.Count, Is.EqualTo(3));
            Assert.That(result[0].RegistrationTime, Is.EqualTo(new DateTime(2025, 8, 8, 10, 0, 0)));
            Assert.That(result[1].RegistrationTime, Is.EqualTo(new DateTime(2025, 8, 8, 11, 0, 0)));
            Assert.That(result[2].RegistrationTime, Is.EqualTo(new DateTime(2025, 8, 8, 12, 0, 0)));
        }
        ...
        public void ParseRegistrationMessage_MultipleSlotsSingleLine_ReturnsMultipleRegistrations2()
        {
            ...
            Assert.That(result[3].RegistrationTime, Is.EqualTo(new DateTime(2025, 8, 8, 10, 0, 0)));
        }
        ...
        public void ParseRegistrationMessage_MixedNamesAndTimes_ReturnsCorrectRegistrations()
        {
            ...
            Assert.That(result[2].RegistrationTime, Is.EqualTo(new DateTime(2025, 8, 8, 10, 0, 0)));
            Assert.That(result[3].Name, Is.EqualTo("Karlenko M."));
            Assert.That(result[3].RegistrationTime, Is.EqualTo(new DateTime(2025, 8, 8, 11, 0, 0)));
        }
        ...
        public void ParseRegistrationMessage_MixedSlotNumbersAndTimes_ReturnsCorrectRegistrations()
        {
            ...
            Assert.That(result[0].Name, Is.EqualTo("Karlenko"));
            Assert.That(result[0].RegistrationTime, Is.EqualTo(new DateTime(2025, 8, 8, 10, 0, 0))); // слот 1
            Assert.That(result[1].Name, Is.EqualTo("Karlenko"));
            Assert.That(result[1].RegistrationTime, Is.EqualTo(new DateTime(2025, 8, 8, 11, 0, 0))); // слот 2

            Assert.That(result[2].Name, Is.EqualTo("Tom"));
            Assert.That(result[2].RegistrationTime, Is.EqualTo(new DateTime(2025, 8, 8, 10, 0, 0))); // время 10:00
        }
